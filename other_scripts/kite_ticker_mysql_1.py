...
if __name__ == '__main__':
    ...
    scheduler.add_job(job1,
                      IntervalTrigger(seconds=60, start_date='2021-05-03 00:36:00',
                                      end_date='2021-05-03 00:37:00'), id="job1")
    scheduler.start()
...
# scheduler = BackgroundScheduler()
# scheduler.add_job(job1,
#                   IntervalTrigger(seconds=60, start_date='2021-04-19 04:45:00',
#                                   end_date='2021-04-19 11:00:00'), id="job1")
